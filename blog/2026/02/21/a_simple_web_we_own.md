...
It's been several weeks since I write this post. I was surprised at some of the places it popped up. Especially the ones I haven't visited for decades. There was a flavor of reaction that I expected and also found curious. It boiled down to, "I am own not owned or a product, you're owned and are the product". The subtext is I struck a nerve. To salve that point I would like to point out that this has been a problem a long time coming. Better thinkers and writers than me have more forcefully stated this.
