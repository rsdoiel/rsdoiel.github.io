...
Search engines happened pretty early on in the web. If my memory is correct they showed with the arrival of support for [CGI](https://en.wikipedia.org/wiki/Common_Gateway_Interface "Common Gateway Interface") in early web server software. Remember back through the decades I see a pattern.
...
5. A localhost site could stage pages for indexing and I could leverage my personal website to expose my indexes to my web devices like phone.
...
2. Search engines are hard to setup and maintain (e.g. Solr, Opensearch), why would I want to spend time of that?
...
- I'd maintain my personal website using a Raspberry Pi 400. The personal search engine needs to respect the limitations of that device.
...
4. Have a page on my personal website uses these indexes to implement a search and results page
...
5. I am only indexing HTML and plain text
