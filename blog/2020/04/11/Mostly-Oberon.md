...
I am new to both Oberon and the Oberon System.  Oberon language is in the tradition of ALGOL, Pascal, Modula 1 and 2 as well as incorporating ideas from the parent of Object Oriented languages Simula. I found certain aspects of Oberon language took me back to the days when I first learned to program using [Turbo Pascal](https://en.wikipedia.org/wiki/Turbo_Pascal).  Oberon's language shape is more like Pascal than the C family of languages. For that reason I think it has largely been overlooked by many who did not encounter it in their education.

Oberon 7 is Wirth's most recent refinement of the Oberon language.  It is a terse and powerful systems programming language.  It strikes a different computing path then many popular programming languages used in 2020.  If you follow how programming languages evolve you'll recognize that Oberon along with Simula are commonly mentioned.

While Wirth conceived of Oberon in the context of a whole system it's use in research and instruction means it is also well suited to other systems such as [POSIX](https://en.wikipedia.org/wiki/POSIX) based systems.  The difference in programming in Oberon for a POSIX system versus a native Oberon System is primarily in the modules you reference to interface into the operating system.  These posts, at least initially, will focus primarily on using the language in a POSIX environment.
