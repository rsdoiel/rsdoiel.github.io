...
index.html: nav.md footer.md author.md blog/index.md presentations.md cli-tools.md index.tmpl
	mkpongo "blogPosts=blog/index.md" "presentations=presentations.md" "cliTools=cli-tools.md" "aboutAuthor=author.md" "nav=nav.md" "footer=footer.md" index.tmpl > index.html
	git add index.html

presentations.html: presentations.md footer.md nav.md presentations.tmpl
	mkpongo "mdfile=text:presentations.md" "presentations=presentations.md" "nav=nav.md" "footer=footer.md" presentations.tmpl > presentations.html
	git add presentations.html

about.html: nav.md footer.md author.md bio.md about.tmpl
	mkpongo "mdfile=text:bio.md" "aboutAuthor=author.md" "pageContent=bio.md" "nav=nav.md" "footer=footer.md" about.tmpl > about.html
	git add about.html

cv.html: nav.md footer.md cv.md cv.tmpl
	mkpongo "mdfile=text:cv.md" "pageContent=cv.md" "nav=nav.md" "footer=footer.md" cv.tmpl > cv.html
	git add cv.html

resume.html: nav.md footer.md resume.md resume.tmpl
	mkpongo "mdfile=text:resume.md" "pageContent=resume.md" "nav=nav.md" "footer=footer.md" resume.tmpl > resume.html
	git add resume.html


library-terminology.html: nav.md footer.md library-terminology.md library-terminology.tmpl
	mkpongo "mdfile=text:library-terminology.md" "pageContent=library-terminology.md" "nav=nav.md" "footer=footer.md" library-terminology.tmpl > library-terminology.html
...
rssfeed.html: rssfeed.md
	mkpongo "mdfile=text:rssfeed.md" "pageContent=rssfeed.md" "nav=nav.md" "footer=footer.md" about.tmpl > rssfeed.html
